...
import com.book.fairy.sys.dto.GenerateInput;
...
public class TemplateUtil {
	...
	public static String getTemplete(String fileName) {
		return com.book.fairy.utils.FileUtil.getText(TemplateUtil.class.getClassLoader().getResourceAsStream("generate/" + fileName));
	}
	...
	public static void saveJava(GenerateInput input) {
		...
		com.book.fairy.utils.FileUtil.saveTextFile(text, path + File.separator + getPackagePath(beanPackageName) + beanName + ".java");
...
//			}
	...
	public static void saveJavaDao(GenerateInput input) {
		...
		com.book.fairy.utils.FileUtil.saveTextFile(text, path + File.separator + getPackagePath(daoPackageName) + daoName + ".java");
		...
		com.book.fairy.utils.FileUtil.saveTextFile(text, path + File.separator + beanName + "Mapper.xml");
	}
	...
	public static String lowerFirstChar(String beanName) {
		String name = com.book.fairy.utils.StrUtil.str2hump(beanName);
	...
	public static void saveController(GenerateInput input) {
		...
		com.book.fairy.utils.FileUtil.saveTextFile(text, path + File.separator + getPackagePath(input.getControllerPkgName())
	...
	public static void saveHtmlList(GenerateInput input) {
		...
		com.book.fairy.utils.FileUtil.saveTextFile(text, path + File.separator + beanParamName + "List.html");
		log.debug("生成查询页面：{}模板", beanName);

		text = getTemplete("htmlAdd.txt");
		text = text.replace("{beanParamName}", beanParamName);
		text = text.replace("{addDivs}", getAddDivs(beanFieldNames));
		com.book.fairy.utils.FileUtil.saveTextFile(text, path + File.separator + "add" + beanName + ".html");
		...
		com.book.fairy.utils.FileUtil.saveTextFile(text, path + File.separator + "update" + beanName + ".html");
