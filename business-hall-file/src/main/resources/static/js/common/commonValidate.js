/**
 * Created by yangzhou-he on 2017/6/22.
 */

var yzCommonValidate = $.extend({}, yzCommonValidate);/* 定义全局对象，类似于命名空间或包的作用 */
 ...
 */
yzCommonValidate.valiDate = function(dateValue){
 ...
 * @return
 */
yzCommonValidate.isValidityBrithBy15IdCard=function(idCard15){
 ...
 * @constructor
 */
yzCommonValidate.RQcheck = function (datatime) {
    var date = datatime;
